...
```
Your passports, IDs, cards, and notes — encrypted on-device with AES-256 in Apple's Secure Enclave. No servers. No subscriptions. Just $1.99 to go Pro.
```
*(166)*
...
▸ EXPIRY REMINDERS
Add an Expiry field to any entry and Kryptos sends a local notification 30 days, 7 days, and 1 day before it expires. All scheduled offline through UNUserNotificationCenter — no cloud dependency.
...
• Face ID / Touch ID — to unlock your vault
• Notifications — for expiry reminders
• Internet — only for Sign in with Apple/Google, iCloud sync, Drive backup, and App Store purchase verification
...
Terms & FAQ: https://kryptos.faizalmzain.com/faq
```
